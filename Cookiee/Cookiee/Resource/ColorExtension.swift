...
extension Color {
    ...
    static let Beige01 = Color(hex: "#F7F2E7")
    ...
    static let Brown04 = Color(hex: "#BEB2B2")
    static let Brown05 = Color(hex: "#CFC3C3")
    static let Brown06 = Color(hex: "#DACDCD")
    static let Brown07 = Color(hex: "#EDE2E2")
